...
import (
	...
	"github.com/xinchuantw/hoki-tabloid-backend/utils/random"
...
var AvailableContactCombinationLists = []string{
	ContactMediumPhone + "-" + ContactTypePrimary,
	ContactMediumPhone + "-" + ContactTypeAlternative,
